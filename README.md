## fields2cover (noetic) - 2.0.0-4

The packages in the `fields2cover` repository were released into the `noetic` distro by running `/usr/bin/bloom-release fields2cover --track noetic --rosdistro noetic` on `Tue, 04 Jun 2024 14:17:40 -0000`
...
## fields2cover (noetic) - 2.0.0-3

The packages in the `fields2cover` repository were released into the `noetic` distro by running `/usr/bin/bloom-release fields2cover --track noetic --rosdistro noetic` on `Mon, 13 May 2024 15:57:24 -0000`
...
## fields2cover (noetic) - 2.0.0-2

The packages in the `fields2cover` repository were released into the `noetic` distro by running `/usr/bin/bloom-release fields2cover --track noetic --rosdistro noetic` on `Mon, 29 Apr 2024 09:47:31 -0000`
